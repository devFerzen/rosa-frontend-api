    ...
    <v-card-text class="pb-0">
      ...
      <v-row no-gutters>
        <v-col order="1" :cols="cols['formSearchField']">
          <v-text-field label="Lorem ipsum" placeholder="Lorem ipsum" outlined></v-text-field>
        </v-col>
        <!--Busqueda-->
        ...
        <v-col cols="6" class="mr-1 mb-0" :order="panelCSS.colOrder.estados" v-show="panelCSS.masFiltros">
          <v-select :items="estados" label="Estados" outlined class="mb-0"></v-select>
        </v-col>
        <!--Estados-->

        <v-col :order="panelCSS.colOrder.ciudades" v-show="panelCSS.masFiltros">
          <v-select :items="ciudades" label="Ciudades" outlined></v-select>
        </v-col>
        <!--Ciudades-->
