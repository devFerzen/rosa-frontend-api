    ...
    <v-row>
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="
            ...
            overflow: hidden;
            position: relative;">
          <v-img lazy-src="https://tse2.mm.bing.net/th?id=OIP.o8NGR0z2j5kgMMP3eL-hAgHaFn&pid=Api" min-height="500px"
            max-height="500px" max-width="100%" position="center center"
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="height: 500px; max-height: 500px; position: relative">
          <v-img min-height="500px" max-height="500px" max-width="100%"
            lazy-src="https://tse4.mm.bing.net/th?id=OIP.4ge4xFDqi-g5CsoZ3cdunwHaLH&pid=Api" position="center center"
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="height: 500px; max-height: 500px; overflow: hidden">
          <v-img lazy-src="https://tse1.explicit.bing.net/th?id=OIP.jF81v_wLUP6MEpMD9mDo-wHaKB&pid=Api"
            min-height="500px" max-height="500px" max-width="100%" position="center center"
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="
            ...
            position: relative;
          ">
          <v-img lazy-src="https://tse2.mm.bing.net/th?id=OIP.o8NGR0z2j5kgMMP3eL-hAgHaFn&pid=Api" max-height="100%"
            src="https://tse2.mm.bing.net/th?id=OIP.o8NGR0z2j5kgMMP3eL-hAgHaFn&pid=Api" style="
              position: absolute;
              top: 50%;
              left: 50%;
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="height: 500px; max-height: 500px; position: relative">
          <v-img max-height="100%" lazy-src="https://tse4.mm.bing.net/th?id=OIP.4ge4xFDqi-g5CsoZ3cdunwHaLH&pid=Api"
            src="https://tse4.mm.bing.net/th?id=OIP.4ge4xFDqi-g5CsoZ3cdunwHaLH&pid=Api" style="
              position: absolute;
              top: 50%;
              left: 50%;
              transform: translate(-50%, -50%);
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="
          ...
          ">
          <v-img lazy-src="https://tse1.explicit.bing.net/th?id=OIP.jF81v_wLUP6MEpMD9mDo-wHaKB&pid=Api"
            max-height="100%" src="https://tse1.explicit.bing.net/th?id=OIP.jF81v_wLUP6MEpMD9mDo-wHaKB&pid=Api" style="
              position: absolute;
              top: 50%;
              left: 50%;
              transform: translate(-50%, -50%);
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="
          ...
          ">
          <v-img lazy-src="https://tse2.mm.bing.net/th?id=OIP.o8NGR0z2j5kgMMP3eL-hAgHaFn&pid=Api" max-height="100%"
            contain src="https://tse2.mm.bing.net/th?id=OIP.o8NGR0z2j5kgMMP3eL-hAgHaFn&pid=Api" style="
              position: absolute;
              top: 50%;
              left: 50%;
              transform: translate(-50%, -50%);
      ...
      <v-col :cols="gridCardWH['cardCols']">
        <v-card class="rounded-xl" style="
          ...
          ">
          <v-img lazy-src="https://tse1.explicit.bing.net/th?id=OIP.jF81v_wLUP6MEpMD9mDo-wHaKB&pid=Api"
            max-height="100%" contain src="https://tse1.explicit.bing.net/th?id=OIP.jF81v_wLUP6MEpMD9mDo-wHaKB&pid=Api"
            style="
              position: absolute;
              top: 50%;
              left: 50%;
            ...
            <v-col cols="12" md="8" style="min-height: 95vh; max-height: auto"
              ...
              <v-card class="pa-4 pa-lg-2" outlined style="background-color: lightgrey" tile
                ...
                <v-tabs class="d-flex flex-column-reverse">
                        ...
                        <v-col>
                          <v-list shaped>
                            <v-list-item-group color="primary" v-model="selectedItem">
                              <v-list-item v-for="(
                                  contacto, i
                                ) in anuncioView.Sec_Contacto" :key="i">
                                <v-list-item-icon>
                  ...
                  <v-tab v-for="(anuncio, key, i) in anuncioView" :key="i" v-if="
                      key == 'Sec_Descripcion' ||
                      key == 'Sec_Contacto' ||
                      key == 'Sec_Tarifas'
                    ">
