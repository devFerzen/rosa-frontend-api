  ...
  <v-container fluid fill-height class="white">
    <v-row align="start" justify="center">
      ...
      <v-col
        ...
        <sistema-tarjetas :fullAnuncioEstado="hayAnuncio" v-else-if="!iniciandoSesion && !registrandose"/>
      </v-col>
    </v-row>
  </v-container>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      activandoGrid(WidthComponents){
        ...
        this.widthComponents.herramientasWidth = WidthComponents.herramientasWidth;
